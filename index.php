...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://goldfish-app-dki9t.ondigitalocean.app/";
	...
	<a href="https://goldfish-app-dki9t.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
