...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://goldfish-app-d8cut.ondigitalocean.app/";
	...
	<a href="https://goldfish-app-d8cut.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
